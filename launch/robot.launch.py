...
def generate_launch_description():
    ...
    world_path = os.path.join(get_package_share_directory(package_name),'description', 'obstacles.world')
    ...
    urdf_path = os.path.join(get_package_share_directory(package_name),'description','lemower.xacro')
